{
 "cells": [
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "Impact of target lock. In the first matrix attacker plays \"Focus\" while defender plays \"Evasion\". In the second matrix the Attacker plays Target Lock, defender plays the Evasion. \n",
    "\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Victory A: 0.451 Victory B 0.549\n",
      "Victory A: 0.847 Victory B 0.153\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Victory A: 0.411 Victory B 0.589\n",
      "Victory A: 0.372 Victory B 0.628\n",
      "Victory A: 0.337 Victory B 0.663\n"
     ]
    }
   ],
   "source": [
